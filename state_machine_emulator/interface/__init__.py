...
class RPI_PICO_PIO_interface():
    ...
    # Imported methods
    from ._toolbar import build_toolbar, step_callback, quit_callback, step_10_callback, step_50_callback, restart_callback, step_10_back_callback, step_50_back_callback, step_back_callback
    ...
    def check(self):
        """ this is just a simple activity to allow ctrl-c to function """
        self.root.after(50, self.check)  # 50 stands for 50 ms.
